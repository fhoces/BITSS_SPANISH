...
% Two titles:
% 1 - Nuevos desafíos para la investigación y las políticas públicas: reproducibilidad, transparencia y credibilidad
% 2 - Transparencia en Investigación en las Ciencias Sociales
\subtitle
{}	
...
\date[BITSS2018] % (optional, should be abbreviation of conference name)
{MIES, Octubre 2018\\
